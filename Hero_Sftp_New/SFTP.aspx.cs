...
public partial class herofestive_lead_dashboard_report_new : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            txtFromTime.Text = DateTime.Now.AddMinutes(-30).ToString("HH:mm");
    ...
    public void export()
    {
        ...
        using (XLWorkbook wb = new XLWorkbook())
        {
            ...
            {
                string sName = "HeroLeads_" + DateTime.Now.Day.ToString() + "_" + DateTime.Now.Month.ToString() + "_" + DateTime.Now.Year.ToString() + "_" + DateTime.Now.Hour.ToString() + "_" + DateTime.Now.Minute.ToString();
                string sPath = sName;
