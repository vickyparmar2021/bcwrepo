<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SFTPCronJob.aspx.cs" Inherits="SFTPCronJob" %>
                            ...
                            <div class="box-content">
                                <fieldset>
                                    ...
                                    <div>
                                        ...
                                        <asp:CheckBoxList ID="CheckBoxList1" runat="server" DataTextField="prod_name" DataValueField="prod_id" RepeatDirection="Horizontal" RepeatColumns="6" TextAlign="Right" OnSelectedIndexChanged="CheckBox_Checked_Unchecked" AutoPostBack="true"></asp:CheckBoxList>
                                        <br />
                                    ...
                                    <div class="EU_TableScroll" id="showData" style="display: block">
                                        <asp:GridView ID="GridView2" runat="server" Width="100%" EnableModelValidation="True" AutoGenerateColumns="false" DataKeyNames="Id" Visible="false" OnRowDataBound="GridView2_RowDataBound">
                                            <HeaderStyle BackColor="#5D5C5C" ForeColor="#ffffff" />
                                            <Columns>
